...
//change to false
const bool Greater(true); // whether thresholding in region growing will be performed according to the greater values or according to the smaller values....
...
vtkDataSet * ReadNcDataFile(float ** Data_out,string FileName,float ** Xcoord, float**Ycoord, float **Zcoord, int x_dim, int y_dim, int z_dim)
{
    ...
    string GRID_FILE_NAME = "/home/liliu/Enrique/NWA_grd.nc";
